    ...
    public partial class Form1 : Form
    {
        ...
        void getWeather()
        {
            using (WebClient web = new WebClient())
            {
                ...
                // Sun(rise)set in UTC
                Sunset.Text = "Sunset : " + convertDateTime(myDeserializedClass.sys.sunset).ToShortTimeString();
                Sunrise.Text = "Surise : " + convertDateTime(myDeserializedClass.sys.sunrise).ToShortTimeString();
                ...
                Speed.Text = "Wind : " + sp.ToString() + " km/h ";
        ...
        void getForcast()
        {
            using (WebClient web = new WebClient())
            {
                ...
                double tempera1 = ConvertKC(myDeserializedClass.list[6].main.temp_min);
                ...
                day3.Text = string.Format("{0}", getDate(myDeserializedClass.list[22].dt).DayOfWeek);
                ...
                double tempera3max = ConvertKC(myDeserializedClass.list[22].main.temp_max);
                double tempe3max = Convert.ToInt32(tempera3max);
                max3.Text = tempe3max.ToString() + " °C ";
                pictureBox3.ImageLocation = "https://openweathermap.org/img/w/" + myDeserializedClass.list[22].weather[0].icon + ".png";

                day4.Text = string.Format("{0}", getDate(myDeserializedClass.list[29].dt).DayOfWeek);
                double tempera4 = ConvertKC(myDeserializedClass.list[23].main.temp_min);
                double tempe4 = Convert.ToInt32(tempera3);
                min4.Text = tempe4.ToString() + " °C ";
                double tempera4max = ConvertKC(myDeserializedClass.list[29].main.temp_max);
                double tempe4max = Convert.ToInt32(tempera4max);
                max4.Text = tempe4max.ToString() + " °C ";
                pictureBox4.ImageLocation = "https://openweathermap.org/img/w/" + myDeserializedClass.list[29].weather[0].icon + ".png";

                day5.Text = string.Format("{0}", getDate(myDeserializedClass.list[39].dt).DayOfWeek);
                double tempera5 = ConvertKC(myDeserializedClass.list[32].main.temp_min);
                double tempe5 = Convert.ToInt32(tempera5);
                min5.Text = tempe5.ToString() + " °C ";
                double tempera5max = ConvertKC(myDeserializedClass.list[39].main.temp_max);
                ...
                date.Text = string.Format("{0}", getDate(myDeserializedClass.list[0].dt));
                id.Text = string.Format("{0}", myDeserializedClass.city.country);
                vi.Text = string.Format("{0}", myDeserializedClass.city.name);

                string h1e = convertDateTime(myDeserializedClass.list[1].dt).ToString();
                string h1h = h1e.Substring(11);
                h1.Text = h1h.ToString();
                double h1t = ConvertKC(myDeserializedClass.list[1].main.temp_max);
                double h1tc = Convert.ToInt32(h1t);
                t1.Text = h1tc.ToString() + " °C ";
                p1.ImageLocation = "https://openweathermap.org/img/w/" + myDeserializedClass.list[1].weather[0].icon + ".png";

                string h2e = convertDateTime(myDeserializedClass.list[2].dt).ToString();
                string h2h = h2e.Substring(11);
                h2.Text = h2h.ToString();
                double h2t = ConvertKC(myDeserializedClass.list[2].main.temp_max);
                double h2tc = Convert.ToInt32(h1t);
                t2.Text = h1tc.ToString() + " °C ";
                p2.ImageLocation = "https://openweathermap.org/img/w/" + myDeserializedClass.list[2].weather[0].icon + ".png";

                string h3e = convertDateTime(myDeserializedClass.list[3].dt).ToString();
                string h3h = h3e.Substring(11);
                h3.Text = h3h.ToString();
                double h3t = ConvertKC(myDeserializedClass.list[3].main.temp_max);
                double h3tc = Convert.ToInt32(h3t);
                t3.Text = h3tc.ToString() + " °C ";
                p3.ImageLocation = "https://openweathermap.org/img/w/" + myDeserializedClass.list[3].weather[0].icon + ".png";
        ...
        private void CityO_SelectedIndexChanged(object sender, EventArgs e)
        {
